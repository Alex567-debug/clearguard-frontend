...
const MOCK_ROWS = [
  {
    id: 1,
    param: "BOD₅",
    fullName: "5-Day Biochemical Oxygen Demand",
    limitType: "Monthly Avg",
    limitVal: 30.0,
    limitStr: "30.0 mg/L",
    measured: 28.5,
    unit: "mg/L",
  ...
  },
  {
    id: 3,
    param: "pH",
    fullName: "Hydrogen Ion Concentration",
    limitType: "Inst. Max",
    limitVal: 9.0,
    limitStr: "6.0–9.0 SU",
    measured: 9.4,
  ...
  },
  {
    id: 6,
    param: "E. coli",
    fullName: "Fecal Coliform (E. coli)",
    limitType: "Geo. Mean",
    limitVal: 126,
    limitStr: "126 CFU/100mL",
    measured: 89,
    unit: "CFU/100mL",
    freq: "Monthly",
    sample: "Grab",
...
function MetricCard({ label, value, sub, valueColor }) {
  return (
    ...
    >
      ...
      {sub && (
        <div style={{ fontSize: 11, color: T.subtle, marginTop: 4 }}>{sub}</div>
      )}
    </div>
  );
}
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <svg width="44" height="48" viewBox="0 0 600 600" fill="none">
          ...
          <g fill="#0A1526" clipPath="url(#navShieldClip)">
            <circle cx="300" cy="142" r="7" />
            <circle cx="190" cy="244" r="7" />
            <circle cx="410" cy="244" r="7" />
            <circle cx="78" cy="218" r="7" />
            <circle cx="522" cy="218" r="7" />
            <circle cx="300" cy="318" r="7" />
            <circle cx="174" cy="374" r="7" />
            <circle cx="426" cy="374" r="7" />
            <circle cx="218" cy="474" r="7" />
            <circle cx="382" cy="474" r="7" />
            <circle cx="300" cy="474" r="7" />
            <circle cx="300" cy="562" r="7" />
          </g>

          {/* ── WATER DROP ── */}
          <path
            d="M300,172 C300,172 380,280 380,358 C380,405 344,444 300,444 C256,444 220,405 220,358 C220,280 300,172 300,172 Z"
            stroke="#0A1526"
            strokeWidth="14"
            fill="none"
          ...
          />
          <path
            d="M300,178 C300,178 374,282 374,357 C374,401 341,438 300,438 C259,438 226,401 226,357 C226,282 300,178 300,178 Z"
            fill="#0A1526"
          />
          <path
            d="M300,195 C300,195 360,288 360,355 C360,394 333,424 300,424 C267,424 240,394 240,355 C240,288 300,195 300,195 Z"
            stroke="url(#navDropGrad)"
            strokeWidth="5"
            fill="none"
            filter="url(#navNeonGlow)"
            strokeLinejoin="round"
          />

          {/* ── PCB TRACES ── */}
          <path
            d="M300,240 V272 H256 L242,286 V318"
            stroke="url(#navDropGrad)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
            strokeLinejoin="round"
            filter="url(#navSoftGlow)"
          />
          <path
            d="M300,272 H346 L360,286 V318 H326"
            stroke="url(#navDropGrad)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
          ...
          />
          <path
            d="M300,350 V378 H268 L256,390 V412"
            stroke="url(#navDropGrad)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
          ...
          <g fill="#00F2FE" filter="url(#navSoftGlow)">
            <circle cx="300" cy="236" r="6.5" />
            <circle cx="242" cy="322" r="6" />
            <circle cx="326" cy="322" r="6" />{" "}
            <circle cx="300" cy="346" r="5" />
            <circle cx="256" cy="414" r="6" />{" "}
            <circle cx="350" cy="394" r="6" />
          </g>

          {/* ── FOREGROUND SHIELD ── */}
          <path
            d="M108,118 L300,158 L492,118 L492,328 L300,532 L108,328 Z"
            stroke="#0A1526"
            strokeWidth="1.5"
            fill="none"
            opacity="0.45"
          />
          <path
            d="M78,98 L300,142 L522,98 L522,338 L300,562 L78,338 Z"
            stroke="#0A1526"
            strokeWidth="6"
            fill="none"
          ...
          <g fill="#0A1526">
            ...
            <circle cx="300" cy="142" r="8" />
            <circle cx="522" cy="98" r="8" />
            <circle cx="78" cy="218" r="7" />
            <circle cx="522" cy="218" r="7" />
            <circle cx="78" cy="338" r="8" />
            <circle cx="522" cy="338" r="8" />
            <circle cx="300" cy="562" r="8" />
            <circle cx="190" cy="244" r="7" />
            <circle cx="410" cy="244" r="7" />
            <circle cx="174" cy="374" r="7" />
            <circle cx="426" cy="374" r="7" />
      ...
      <div style={{ maxWidth: 560, margin: "72px auto", padding: "0 20px" }}>
        ...
        <div
          ...
          style={{
            ...
            textAlign: "center",
            cursor: "pointer",
            background: dragging ? "#eff6ff" : T.surface,
        ...
        >
          ...
          >
            <rect
              ...
              height="44"
              rx="10"
              fill={dragging ? "#dbeafe" : "#f1f5f9"}
            />
            <path
              d="M22 28V16M22 16l-5 5M22 16l5 5"
              stroke={dragging ? T.accent : T.muted}
              strokeWidth="2"
              strokeLinecap="round"
            />
            <path
        ...
        <div style={{ textAlign: "center", marginTop: 16 }}>
          ...
          >
            → Load demo permit (IN0012345, Indiana)
          </button>
        </div>
        ...
        >
          {[
            ["📄", "Works with any EPA permit format"],
            ["🤖", "AI handles complex layouts"],
            ...
            >
              ...
              <span
                style={{
                  ...
                  color:
                    i === current ? T.text : i < current ? T.success : T.subtle,
                }}
              >
                {step}
              </span>
...
function ResultsStage({
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg }}>
      <Nav onReset={onReset} />
      <div
        style={{ maxWidth: 1080, margin: "0 auto", padding: "28px 20px 48px" }}
      >
        {/* API status banner */}
        {isLiveData ? (
          <div
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
              {[
                ["Permit No.", facility.permitNo],
                ["Outfall", facility.outfall],
                ["Period", facility.period],
                ["Expires", facility.expires],
              ].map(([lbl, val]) => (
                <div key={lbl}>
                  <div
                    style={{
        ...
        >
          <MetricCard
            ...
            value={rows.length}
            sub="Extracted from permit"
          />
          <MetricCard
            label="Exceedances"
            value={exceedances.length}
            sub={
              exceedances.length ? "Require immediate action" : "None detected"
            }
          ...
          <MetricCard
            ...
            sub={
              isLiveData && pending.length > 0
                ? "Upload DMR to verify"
                : "Based on permit limits"
            }
            valueColor={
              exceedances.length
                ? T.danger
                : isLiveData && pending.length
                ? T.warn
                : T.success
            }
          />
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {exceedances.length > 0 && (
                <Pill
                  label={`${exceedances.length} Exceedances`}
                  color={T.danger}
                />
              )}
              {pending.length > 0 && (
                <Pill
                  label={`${pending.length} Awaiting DMR`}
                  color={T.muted}
                />
              )}
                    ...
                    <tr
                      ...
                      style={{
                        ...
                        borderLeft: `3px solid ${
                          exceed ? T.danger : pend ? T.border : "transparent"
                        }`,
                      }}
                    >
                      <td
                        ...
                        {dev ? (
                          <span
                            style={{
                              fontWeight: 700,
                              fontSize: 13,
                              color: dev.over ? T.danger : T.success,
                            }}
                          >
                            {dev.str}
                          </span>
          ...
          >
            <span>
              {isLiveData ? "Live API" : "Mock data"} ·{" "}
              {fileName || "demo permit"}
              &nbsp;·&nbsp;40 CFR Part 122
            </span>
  ...
  const processFile = async (file) => {
    ...
    try {
      ...
      if (!apiRes.ok) {
        ...
        throw new Error(
          `${apiRes.status} ${apiRes.statusText}: ${errText.slice(0, 120)}`
        );
      }
      ...
      setRows(mapped.rows);
      setFacility(
        mapped.facility.name !== "—"
          ? mapped.facility
          : { ...MOCK_FACILITY, ...mapped.facility }
      );
      setIsLiveData(true);
      setApiError(null);
    } catch (err) {
